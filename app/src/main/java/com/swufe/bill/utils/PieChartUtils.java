...
//            drawable = getDrawable(GlobalUtil.getInstance().getResourceIcon(category))
//
//                    ;GlobalUtil.getInstance().getResourceIcon(category).getD;
//                    getResources().getDrawable(R.mipmap.type_shouxufei);
